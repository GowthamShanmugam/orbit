        ...
        <div className="mt-3 flex flex-wrap items-center gap-2 border-t border-[var(--o-border)] pt-3">
          ...
          {onEdit && (
            <button
              type="button"
              onClick={onEdit}
              className="inline-flex items-center gap-1.5 rounded-md border border-[var(--o-border)] bg-[var(--o-bg-subtle)] px-2.5 py-1.5 text-xs font-medium text-[var(--o-text)] transition-colors hover:border-[var(--o-accent)]/40"
              title="Edit cluster — rotate token or kubeconfig"
            >
