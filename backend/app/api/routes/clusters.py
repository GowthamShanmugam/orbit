...
async def update_cluster(
    ...
    if body.namespace_filter is not ...:
        kwargs["namespace_filter"] = body.namespace_filter
    if body.sync_config is not ...:
        kwargs["sync_config"] = body.sync_config
    if body.credentials is not None:
        kwargs["credentials"] = body.credentials
    if body.api_server_url is not ...:
        kwargs["api_server_url"] = body.api_server_url

    updated = await cluster_service.update_cluster(db, cluster, **kwargs)
